...
class Etapa
{
    ...
    public function cadastrarEtapa(string $nome, string $unidade, array $materiais)
    {
        $materialEtapa = new MaterialEtapa($this->sqlite);

        $insertEtapa = $this->sqlite->prepare('INSERT INTO etapa(nome, unidade) 
                                                VALUES (:nome, :unidade)');
                                
        $insertEtapa->bindParam(':nome', $nome);
        $insertEtapa->bindParam(':unidade', $unidade);
    ...
    public function editarEtapa(string $nome, string $unidade, int $id, array $materiais)
    {
        $materialEtapa = new MaterialEtapa($this->sqlite);
        ...
        $updateEtapa->bindParam(':unidade', $unidade);
